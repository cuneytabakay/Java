...
public class _06_JavaMath {
    public static void main(String[] args) {
        ...
        System.out.println("floor 3.1 = " + Math.floor(3.1) ); // bu rakamdan küçük en yakın tam sayı 4
        System.out.println("floor 3.5 = " + Math.floor(3.5) ); // bu rakamdan küçük en yakın tam sayı 4
