...
public class _04_StringIndexOf {
    public static void main(String[] args) {
        ...
        // Merhaba kelimesindeki a nin indexini bulmak için kelime.IndexOf("a") -> ilk bulduğun INDEX ini verir 4 verir
        // eğer bulmazsa -1 gönderir, bulunamadı manasında.
        ...
        System.out.println("kelime.indexOf(a) = " + kelime.indexOf("a" , 5));  // 4 den sonrakileride araştır
