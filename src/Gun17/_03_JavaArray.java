...
public class _03_JavaArray {
    public static void main(String[] args) {
        ...
        int[] dizi2={5,77,88,99,0,1,63}; // hem uzunluğu hem değerleri verildi. uzunluk=eleman sayısı
        ...
        Double[] oranlar=new Double[5]; //  5 tane Double cinsi saklayabilen bir dizi değişken
